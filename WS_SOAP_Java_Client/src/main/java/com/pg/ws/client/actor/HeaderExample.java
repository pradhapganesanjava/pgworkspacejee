package com.pg.ws.client.actor;
...
public class HeaderExample {
	public static void main(String[] args) {
		...
		try {
			...
			SOAPHeaderElement shippingHeader = header
					.addHeaderElement(shipping);
			...
			QName confirmation = new QName(nameSpaceURI, "confirmationDesk",
					nameSpace);
			SOAPHeaderElement confirmationHeader = header
					.addHeaderElement(confirmation);
