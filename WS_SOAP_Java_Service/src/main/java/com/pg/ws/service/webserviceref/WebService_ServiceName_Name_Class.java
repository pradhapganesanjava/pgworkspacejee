...
@WebService (serviceName="WebService_ServiceName_Name_ClassService",name="WebService_ServiceName_Name_ClassSEI")
public class WebService_ServiceName_Name_Class {
	...
	public static void main(String...str){
		EndpointPublisher.main("6565","/wsservicenamenameclass","com.pg.ws.service.webserviceref.WebService_ServiceName_Name_Class");
	}
}
